    ...
    <div style={S.container}>
      <div style={S.poem}>
        ...
        <div style={S.stanza}>
          ...
          <L><P>(Frost would probably have opinions)</P><Sup n="4" /></L>
      ...
      <div style={S.annotation}>
        ...
        <p style={S.note}><span style={S.noteNum}>1</span> Likely refers to an overactive mind, a common theme in Black's work. Similar phrasing appears in The Hours We Cannot Name (2021).</p>
        ...
        <p style={S.note}><span style={S.noteNum}>4</span> A sarcastic nod to poet Robert Frost, known for "The Road Not Taken." The phrase suggests disdain for neat literary conclusions.</p>
      </div>
    </div>
  );
}
