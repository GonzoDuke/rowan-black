  ...
  return (
    <div style={S.container}>
      <div style={S.poem}>
        ...
        <div style={S.stanza}>
          <L>acceleration = mass × grief ÷ altitude</L>
        ...
        <div style={S.stanza}>
          <L>I dream in quantum entanglements<Sup n="1" />:</L>
        ...
        <div style={S.stanza}>
          <L><P>(somewhere a dharma bum<Sup n="2" /></P></L>
        ...
        <div style={S.stanza}>
          ...
          <L>optional</L>
          <L>& all the desolation angels<Sup n="3" /></L>
      ...
      <div style={S.annotation}>
        ...
        <p style={S.note}><span style={S.noteNum}>1</span> Quantum entanglement describes particles remaining connected across distances.</p>
        <p style={S.note}><span style={S.noteNum}>2</span> The Dharma Bums (1958) by Jack Kerouac, a novel about seeking meaning through solitude and wanderlust.</p>
        <p style={S.note}><span style={S.noteNum}>3</span> Desolation Angels (1965) by Jack Kerouac explores themes of solitude, enlightenment, and disillusionment.</p>
      </div>
    </div>
  );
}
