  ...
  return (
    <div style={S.container}>
      <div style={S.poem}>
        ...
        <div style={S.stanza}><L>The blue light burns against our retinas like truth serum, like revelation, like judgment,</L><L>every pixel a mirror reflecting what we've become: hungry ghosts in the machine,</L><L>digital pilgrims searching for salvation in the endless scroll of someone else's pain.</L></div>
        ...
        <div style={S.stanza}><L>In the comments, they perform elaborate rituals of purification and punishment,</L><L>their righteousness measured in character counts, their activism a carefully constructed</L><L>collection of approved phrases, sanctioned hashtags, and properly attributed quotes.</L></div>
      ...
      <div style={S.annotation}>
        ...
        <p style={S.note}><span style={S.noteNum}>1</span> Again, referencing Baudrillard.</p>
      </div>
    </div>
  );
}
