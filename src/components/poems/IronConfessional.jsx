    ...
    <div style={S.container}>
      <div style={S.poem}>
        ...
        <div style={S.stanza}>
          ...
          <L>a different path to paradise.</L>
        </div>
        ...
        <div style={S.stanza}>
          ...
          <L>speaking simultaneously<Sup n="3" />.</L>
        </div>
        <div style={S.stanza}>
        ...
        <div style={S.stanza}>
          ...
          <L><P>but progress always eats the garden<Sup n="4" />).</P></L>
        </div>
        <div style={S.stanza}>
      ...
      <div style={S.annotation}>
        ...
        <p style={S.note}><span style={S.noteNum}>3</span> A biblical reference to the Tower of Babel (Genesis 11), where language was divided.</p>
        <p style={S.note}><span style={S.noteNum}>4</span> A reinterpretation of John 1:1.</p>
      </div>
    </div>
  );
}
