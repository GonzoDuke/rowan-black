  ...
  return (
    <div style={S.container}>
      ...
      <div style={S.annotation}>
        ...
        <p style={S.note}><span style={S.noteNum}>1</span> Reference unclear. Possibly Jack Kerouac.</p>
        <p style={S.note}><span style={S.noteNum}>2</span> A recurring motif in Black's work. Similar themes appear in City of Ghosts (2012) and others.</p>
      </div>
    </div>
  );
}
