...
const MARBLE = `radial-gradient(ellipse at 20% 50%, rgba(0,0,0,0.08) 0%, transparent 50%),
  radial-gradient(ellipse at 80% 20%, rgba(0,0,0,0.06) 0%, transparent 40%),
  radial-gradient(ellipse at 40% 80%, rgba(0,0,0,0.07) 0%, transparent 45%),
  radial-gradient(ellipse at 70% 60%, rgba(0,0,0,0.05) 0%, transparent 35%),
...
const S = {
  ...
  coverLabel: {
    ...
    color: '#2a2520', letterSpacing: '0.04em', fontStyle: 'italic',
    textAlign: 'center',
  },
  pages: {
    background: '#ffffff',
  ...
  receiptHeader: {
    ...
    borderBottom: '1px dashed rgba(0,0,0,0.1)', paddingBottom: '6px',
  },
  receiptLine: {
    fontFamily: "'IBM Plex Mono', monospace", fontSize: '11px',
    lineHeight: 1.6, color: '#555', marginBottom: '2px',
  },
...
export default function RazorsEdge() {
  return (
    <div style={S.outer}>
      <div style={S.compBook}>
        <div style={S.cover}>
          <div style={S.coverLabel}>Ritual Coffee, Valencia St. — Feb 2015</div>
        </div>
        <div style={S.pages}>
          <div style={S.body}>
