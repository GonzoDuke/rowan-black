...
const S = {
  ...
  fileChrome: {
    background: '#e2e0db', border: '1px solid rgba(0,0,0,0.12)',
  ...
  docBody: { padding: 'clamp(20px, 5vw, 36px) clamp(20px, 5vw, 44px)', background: '#e2e0db' },
  ...
  line: {
    fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: '16px',
