...
const RULED_BG = `repeating-linear-gradient(
  ...
  transparent 0px,
  transparent 25px,
  rgba(100,140,200,0.15) 25px,
  rgba(100,140,200,0.15) 26px
)`;

const MARGIN_LINE = `linear-gradient(
  to right,
  transparent 46px,
  rgba(200,70,70,0.2) 46px,
  rgba(200,70,70,0.2) 47px,
  transparent 47px
)`;
...
const S = {
  ...
  page: {
    background: RULED_BG + ',' + MARGIN_LINE + ', #f9f7f2',
  ...
  tornEdge: {
    ...
    background: 'repeating-linear-gradient(to bottom, transparent 0px, transparent 8px, rgba(0,0,0,0.02) 8px, rgba(0,0,0,0.02) 9px, transparent 9px, transparent 16px)',
  },
  holes: {
  ...
  hole: {
    ...
    background: '#eef0f4', border: '1px solid rgba(0,0,0,0.06)',
  },
  coffeeStain: {
    position: 'absolute', bottom: '30px', right: '20px',
    width: '90px', height: '85px', borderRadius: '50%',
    background: 'radial-gradient(ellipse, rgba(140,100,50,0.04) 40%, rgba(140,100,50,0.07) 60%, transparent 72%)',
    pointerEvents: 'none',
  },
  body: {
  ...
  listItem: {
    ...
    lineHeight: 1.6, color: '#2a2520', paddingLeft: '12px',
    marginBottom: '2px',
  },
