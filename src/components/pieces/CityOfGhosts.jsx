...
export default function CityOfGhosts() {
  return (
    <div style={S.outer}>
      ...
      <div style={S.stanza}><span style={S.social}>@everyone @no one</span><span style={S.social}>#trending #forgotten</span><span style={S.social}>[LIKE] [DISLIKE]</span><span style={S.social}>{'{SHARE}'} {'{ISOLATE}'}</span></div>
