...
const LEGAL_RULED = `repeating-linear-gradient(
  to bottom,
  transparent 0px,
  transparent 23px,
...
const S = {
  ...
  replyContainer: {
    marginTop: '24px',
    background: LEGAL_RULED + ', #f7f0b8',
    backgroundPosition: '0 10px',
    border: '1px solid rgba(0,0,0,0.1)',
    borderLeft: '4px solid rgba(180,50,50,0.2)',
    borderRadius: '2px',
    overflow: 'hidden',
  ...
  replyLabel: {
    ...
    color: '#8a7a40', letterSpacing: '0.06em', textTransform: 'uppercase',
  },
  replyBody: {
    padding: '10px clamp(16px, 4vw, 24px) clamp(20px, 4vw, 24px)',
    fontFamily: "'IBM Plex Mono', monospace",
    fontSize: '13px', lineHeight: 1.75, color: '#3a3520',
    fontStyle: 'italic',
  },
  scribbledName: {
    display: 'inline-block', background: '#3a3520',
...
export default function LetterMarch14() {
  return (
    <div style={S.outer}>
      <div style={S.letter}>
        <div style={{ ...S.foldLine, top: '33%' }} />
        <div style={{ ...S.foldLine, top: '66%' }} />
