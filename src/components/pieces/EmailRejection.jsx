...
const S = {
  ...
  emailChrome: {
    background: '#e2e0db', border: '1px solid rgba(0,0,0,0.12)', borderRadius: '6px',
  ...
  body: {
    padding: 'clamp(20px, 5vw, 28px) clamp(16px, 4vw, 24px) clamp(24px, 5vw, 36px)', fontFamily: "'Libre Baskerville', Georgia, serif",
