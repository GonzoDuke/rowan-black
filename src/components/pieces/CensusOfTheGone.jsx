...
const S = {
  ...
  formMeta: { fontFamily: "'IBM Plex Mono', monospace", fontSize: '11px', color: '#9099a8', marginBottom: '24px', lineHeight: 1.6 },
  fieldGroup: { marginBottom: '24px' },
  fieldLabel: { fontFamily: "'IBM Plex Mono', monospace", fontSize: '10px', fontWeight: 600, color: '#1a1d24', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '8px', borderBottom: '1px solid rgba(0,0,0,0.06)', paddingBottom: '4px' },
  fieldValue: { fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: '16px', lineHeight: 1.75, color: '#1a1d24', paddingLeft: '8px', marginBottom: '4px' },
  redacted: { fontFamily: "'IBM Plex Mono', monospace", fontSize: '13px', color: '#9099a8', letterSpacing: '0.02em', paddingLeft: '8px', marginBottom: '4px' },
  blacked: { display: 'inline-block', background: '#1a1d24', borderRadius: '1px', height: '13px', verticalAlign: 'middle', margin: '0 2px' },
  checkbox: { fontFamily: "'IBM Plex Mono', monospace", fontSize: '13px', color: '#1a1d24', paddingLeft: '8px', marginBottom: '6px', lineHeight: 1.6 },
  checkboxChecked: { fontFamily: "'IBM Plex Mono', monospace", fontSize: '13px', color: '#1a1d24', paddingLeft: '8px', marginBottom: '6px', lineHeight: 1.6, fontWeight: 500 },
  handwritten: { fontFamily: "'Nothing You Could Do', cursive", fontSize: '16px', color: '#3a3530', paddingLeft: '8px', lineHeight: 1.35 },
  bullet: { fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: '15px', lineHeight: 1.75, color: '#1a1d24', paddingLeft: '20px', marginBottom: '4px' },
  sectionLabel: { fontFamily: "'IBM Plex Mono', monospace", fontSize: '10px', fontWeight: 600, color: '#9099a8', letterSpacing: '0.06em', textTransform: 'uppercase', marginTop: '28px', marginBottom: '10px', borderTop: '1px solid rgba(0,0,0,0.06)', paddingTop: '12px' },
  error: { fontFamily: "'IBM Plex Mono', monospace", fontSize: '12px', color: '#993333', lineHeight: 1.7, paddingLeft: '8px', marginBottom: '4px' },
  automated: { fontFamily: "'IBM Plex Mono', monospace", fontSize: '11px', color: '#9099a8', lineHeight: 1.7, paddingLeft: '8px', marginBottom: '4px', fontStyle: 'italic' },
  closing: { fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: '16px', lineHeight: 1.85, color: '#1a1d24', marginTop: '16px', paddingLeft: '8px' },
};
...
export default function CensusOfTheGone() {
  return (
    <div style={S.outer}>
      ...
      <div style={S.headnote}>Origin unknown. This document was mailed to the Collective's PO Box in 2024 with no return address. It arrived as a single printed sheet, folded twice, with handwritten additions in the margins. It is unclear whether this is an original work or a found form that has been altered. Presented as received.</div>

      <div style={S.formMeta}>Form 27B-6 | Revised 2024 | For Official Use Only</div>
      ...
      <div style={S.fieldGroup}>
        ...
        <div style={S.fieldValue}><span style={S.blacked}>&nbsp;</span>/<span style={S.blacked}>&nbsp;</span>/<span style={S.blacked}>&nbsp;&nbsp;</span></div>
      ...
      <div style={S.closing}>At some point, the forms stop following protocol. The census workers try to make sense of the wreckage, but the system doesn't allow for entries that simply read: "She was here. Then she wasn't. What else is there to say?"</div>
    </div>
  );
}
